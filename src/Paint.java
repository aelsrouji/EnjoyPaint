...
public class Paint extends JFrame {
    ...
    static private Boolean IsErasing=false;
    ...
    public static Boolean getIsErasing() {
        return IsErasing;
    }

    public static void setIsErasing(Boolean isErasing) {
        IsErasing = isErasing;
    }


    static private Boolean isFilled =false;
